...
const Capabilities = () => {
  return (
    <div className="bg-white">
      <div className="sm:px-[120px] sm:py-[60px] p-5">
        <p className="text-[#032825] sm:text-[54px] leading-[84px] font-semibold">
          Our Capabilities
        </p>
      ...
      <div className="sm:px-[120px] sm:py-[60px] p-5 bg-primary">
        <div className="flex flex-row justify-between items-center">
