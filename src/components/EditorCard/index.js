...
const EditorCard = ({editor}) => {
  return (
     <div className='flex flex-col items-center'>
        <Image src={editor.image} className='border-1 ' />
        ...
        <div className='flex gap-4'>
          ...
          <Image src={linkedin} width={24} height={24} className='object-cover'
           />
           </Link>
        )}
            {editor.figma&&(
          ...
          <Image src={figma} width={24} height={24} className='object-cover'
           />
           </Link>
        )}
             {editor.dribble&&(
          ...
          <Image src={dribble} width={24} height={24} className='object-cover'
           />
           </Link>
        )}
            {editor.behance&&(
          ...
          <Image src={behance} width={24} height={24} className='object-cover'
           />
           </Link>
        )}
        </div>
